...
const AboutPage = () => {
  return (
    <>
      <main className="px-0">
        <div className="px-4">
          <Title
            ...
            description="Himalayan Flavours is more than just a restaurant; it's a celebration of the rich and diverse culinary heritage of the Himalayan region. Nestled in the heart of Victoria, B.C., our restaurant offers an authentic taste of India, Nepal, and China, bringing together the vibrant and bold flavors that define the cultures."
          />
        </div>
      ...
      <main className="mx-auto grid w-full grid-cols-1 gap-8 lg:w-[90%] lg:grid-cols-2 md:gap-16 xl:w-4/5 xl:gap-32">
        <img
          src={img3}
          alt="Newari Cusine"
        ...
        <div className="flex flex-col gap-8 sm:gap-16">
          <div className="flex h-auto flex-col items-start justify-center gap-4 text-pretty lg:h-screen">
