  ...
  return (
    <main>
      ...
      <div className="grid grid-cols-1 gap-16 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
        ...
        {index === 1 || index === 4 ? (
              <>
                <div className="rounded-2xl bg-orange-300/40 p-8 pb-40">
                  <h4 className="mb-2 font-title text-xl font-bold text-dark capitalize">
                    {cuisine.name}
                  </h4>
              ...
              <>
                ...
                <div className="-mt-32 rounded-2xl bg-orange-300/40 p-8 pt-40 bg-green-500">
                  <h4 className="mb-2 font-title text-xl font-bold text-dark capitalize">
                    {cuisine.name}
                  </h4>
                  <ul className="scroll flex flex-wrap gap-2 gap-y-0 h-24 overflow-y-auto">
                    {cuisine.foodMenu.map((dish, idx) => (
                      <li
                        key={dish.id}
                        className="text-sm text-gray-600 2xl:text-base"
