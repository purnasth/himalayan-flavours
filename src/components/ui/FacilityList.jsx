...
const FacilityList = () => {
  return (
    <>
      <main>
        <div className="mb-10 flex flex-col items-start justify-start gap-4 text-pretty md:mb-24">
        ...
        <ul className="grid grid-cols-2 gap-3 md:gap-6 md:grid-cols-4 lg:grid-cols-4">
          {facilities.map((facility) => (
            <li
              key={facility.id}
              className="group relative overflow-hidden text-pretty border border-y px-4 py-3 text-left text-xs transition-all duration-150 ease-linear hover:border-orange-300 hover:bg-orange-300/20 hover:font-bold hover:text-orange-600 md:text-base"
            >
