...
const Footer = () => {
  return (
    <main className="bg-gray-100 p-0">
      ...
      <div className="pointer-events-none absolute bottom-0 -z-10 h-3/4 w-full bg-[url('https://mayurstay.com/prestigio/assets/images/Artboard%201%20copy%205.png')] bg-cover bg-center bg-no-repeat"></div>
      <Contact />
      ...
      <section className="relative p-24">
        ...
        <img src={logo} alt="" className="h-40 w-full object-contain" />
